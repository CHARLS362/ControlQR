...
export async function GET(request: Request) {
    try {
        ...
        const url = `${EXTERNAL_API_BASE_URL}/api/asistencia/obtener-reporte-asistencias?fecha=${date}&institucion_id=${institutionId}&index=${indexParam}&cantidad=${limitParam}`;
        ...
        console.error('Error en /api/attendance/report:', error);
